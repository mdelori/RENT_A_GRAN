...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  Granny.create!( first_name: 'Romane', last_name: 'MAY', born_at: '1916/02/22', user_id: amine.id, photo_url: 'https://cdn-elle.ladmedia.fr/var/plain_site/storage/images/societe/news/une-grand-mere-atteinte-d-un-cancer-devient-la-star-d-instagram-2689254/46790536-1-fre-FR/Une-grand-mere-atteinte-d-un-cancer-devient-la-star-d-Instagram.jpg')
